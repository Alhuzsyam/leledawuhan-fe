          ...
          {hoveredPoint && (
            <g>
              ...
              <circle
                ...
                cy={
                  120 - ((hoveredPoint.data[dataKey] - minValue) / range) * 100
                }
                r="6"
                fill={color}
                stroke="white"
        ...
        {hoveredPoint && (
          <div className="absolute bottom-2 left-2 text-xs bg-gradient-to-r from-lime-600 to-green-600 text-white p-3 rounded-lg shadow-xl border border-lime-300">
            <div className="font-semibold">
              {hoveredPoint.data.time || "N/A"}
            </div>
            <div className="font-medium">
              {title}:{" "}
              {Number.parseFloat(hoveredPoint.data[dataKey] || 0).toFixed(2)}
              {unit}
            </div>
            <div className="text-lime-100 text-xs">
              {hoveredPoint.data.date || "N/A"}
            </div>
          </div>
        )}
      </div>
          ...
          <table className="w-full text-xs">
            ...
            <tbody>
              {data.map((item, index) => (
                <tr
                  key={index}
                  className="border-t border-lime-100 hover:bg-lime-50 transition-colors"
                >
            ...
            {paginatedData.map((item, index) => (
              <tr key={index} className="hover:bg-lime-50 transition-colors">
                {fields.map((field) => (
                  <td
                    key={field.key}
                    className="px-3 py-3 border border-lime-100 font-mono text-right"
                  >
                    {field.format
...
const Sensor = () => {
  ...
  const downloadChartImage = async (chartType, period = "1day") => {
    ...
    try {
      ...
      const link = document.createElement("a");
      link.download = `${chartType}-chart-${selectedPool}-${period}-${
        new Date().toISOString().split("T")[0]
      }.png`;
  ...
  // Update latest data every 1 hour
  useEffect(() => {
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-6 animate-slideInFromLeft">
                ...
                <div>
                  ...
                  <p className="text-white text-lg inline-block mt-1">
                    Pantau data sensor kolam budidaya secara real-time (Update
                    per jam)
                  </p>
                </div>
              </div>
              ...
              {!selectedPool ? (
                <div className="text-center py-16 animate-fadeInUp">
                  ...
                  <p className="text-gray-600 text-lg">
                    Pilih kolam untuk melihat data sensor
                  </p>
                </div>
              ) : !latestData ? (
                <div className="text-center py-16 animate-fadeInUp">
                  ...
                  <p className="text-gray-600 text-lg mb-4">
                    Belum ada data sensor untuk kolam {selectedPool}
                  </p>
                    ...
                    <div className="space-y-4">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="font-bold text-lg metric-value">
                          {formatValue(latestData.pvVoltage, "V")}
                        </span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-gray-600 font-medium">Arus:</span>
                        <span className="font-bold text-lg metric-value">
                          {formatValue(latestData.pvCurrent, "A")}
                        </span>
                      </div>
                      <div className="flex justify-between items-center">
                  ...
                  <div className="bg-white rounded-2xl shadow-xl border-2 border-lime-100 p-8 sensor-card animate-fadeInUp delay-200">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span className="font-bold text-lg metric-value">
                          {formatValue(latestData.battTemp, "°C")}
                        </span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-gray-600 font-medium">
                        ...
                        <span
                          className={`font-bold text-xl ${getStatusColor(
                            latestData.battPercentage
                          )} metric-value`}
                        >
                          {getBatteryIcon(latestData.battPercentage)}{" "}
                          {formatValue(latestData.battPercentage, "%")}
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-2xl shadow-xl border-2 border-lime-100 p-8 sensor-card animate-fadeInUp delay-400">
                    ...
                    <div className="space-y-4">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="font-bold text-lg metric-value">
                          {formatValue(latestData.envTemp, "°C")}
                        </span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-gray-600 font-medium">
                        ...
                        <span
                          className={`font-bold text-lg ${getTempStatusColor(
                            latestData.envTemp
                          )} status-indicator`}
                        >
                          {latestData.envTemp >= 26 && latestData.envTemp <= 32
                            ? "🟢 Normal"
                            : "🟡 Perlu Perhatian"}
                        </span>
                      </div>
                  ...
                  <div className="bg-white rounded-2xl shadow-xl border-2 border-lime-100 p-8 sensor-card animate-fadeInUp delay-500">
                    ...
                    <div className="space-y-4">
                      <div className="flex justify-between items-center">
                        ...
                        <span
                          className={`font-bold text-lg ${getPhStatusColor(
                            latestData.phBioflok
                          )} metric-value`}
                        >
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span
                          className={`font-bold text-lg ${getDoStatusColor(
                            latestData.doBioflok
                          )} metric-value`}
                        >
            ...
            <div className="tab-content">
              {!selectedPool ? (
                <div className="text-center py-16 animate-fadeInUp">
                  ...
                  <p className="text-gray-600 text-lg">
                    Pilih kolam untuk melihat grafik historis
                  </p>
                </div>
                ...
                <div className="text-center py-16 animate-fadeInUp">
                  ...
                  <p className="text-gray-600 text-lg mb-4">
                    Belum ada data historis untuk kolam {selectedPool}
                  </p>
                  <p className="text-gray-500 text-sm">
                    Gunakan MicroController untuk mengirim data sensor ke server
                  </p>
                  ...
                  <div className="bg-white rounded-2xl shadow-xl border-2 border-lime-100 p-6 animate-fadeInUp">
                    ...
                    <div className="flex flex-wrap gap-3">
                      ...
                      >
                        <FileText size={16} />
                        Unduh CSV{" "}
                        {dateFilterActive ? "(Filtered)" : "(All Data)"}
                      </button>
                    </div>
                  </div>
                  {/* View Toggle */}
